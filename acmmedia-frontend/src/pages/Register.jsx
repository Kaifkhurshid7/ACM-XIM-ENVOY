 ...
 * Registration Page
 * 
 * New student account creation with university email validation.
 * Only @xim.edu.in and @stu.xim.edu.in domains are accepted.
 * 
 * Client-side domain validation provides immediate feedback;
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Client-side domain restriction for immediate UX feedback
    ...
    <div className="auth-wrapper">
      <div className="auth-card register-card">
        <header className="auth-header">
          ...
          <p>Official news and engagement platform for ACM student members.</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-section">
            ...
            <p className="form-hint">ACM membership helps us identify official chapter members.</p>
          </div>
        ...
        <div className="auth-footer">
          ...
          <p>ACM core team or coordinator? <span onClick={() => navigate("/admin-login")}>Admin login</span></p>
        </div>
      </div>
    </div>
  );
